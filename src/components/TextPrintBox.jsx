...
//   return (
//     <div>
//       <label className="block mb-1">Text to print (Max 3 lines / 30 words)</label>
//       <textarea
//         rows="3"
//         value={text}
//         onChange={handleChange}
//         placeholder="Type your message..."
//         className={`w-full p-2 rounded border ${theme.border} ${theme.text} bg-transparent resize-none`}
//       />
//     </div>
//   );
// };
